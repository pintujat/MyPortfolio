...
var projectDetails=[
{
	...
	code:"https://github.com/pintujat/YelpCamp",
	image:"yelpcamp.png"
 },
 {
 	id:"1",
	...
	demo:"https://gilpix.github.io/My-Portfolio/",
	code:"https://github.com/pintujat/RESTFulBlog",
	image:"RestFul Blog.png"
 },
{
	id:"2",
	name:"My Portfolio",
	heading:"Pintu Jat Software Developer Portfolio Website",
	description:"pintujat is an software developer portfolio static website for me(Pintu Jat). Designed and written in html, css and javascript. Used two famous librearies <strong>Bootstrap  4.0</strong> and <strong>jQuery</strong> for more effects and designing.",
	demo:"https://pintujat.github.io/MyPortfolio/",
	code:"https://github.com/pintujat/MyPortfolio",
 ...
 },
 {
	...
	demo:"https://pintujat.github.io/TekHub-Lending-Web-Application/",
	code:"https://github.com/pintujat/TekHub-Lending-Web-Application",
	image:"tekhubweb.png"
 },
 {
	id:"4",
	...
	description:"TekHub application is  used by the students of Lambton College to borrow devices  like laptops, lan cables, etc. from the college.<br>Achieved login validation, registration of user and admin<br>Web calls for data exchange between app and AmazonRDS Mysql database<br>Database connectivity between AmazonRDS - Netbeans(webcall) - Android<br>Added features to add item in waiting list, borrow items, filter items list, give feedback/ratings and updatethe database accordingly.<br>Used Agile methodology-SCRUM to develop the app and created SRS documentation. ",
...
function modal(id,name,shortDesc, description,demo,code,image){
	...
	if(id==11 || id==10 || id==9 || id==4 || id==6 || id==8)
	{
		$(".project-code").addClass("hide-cards");
		$(".project-demo").addClass("hide-cards");
	}
	else if(id==5 || id==0 || id==1 )
	{
		$(".project-demo").addClass("hide-cards");
	}
	else if(id==12 || id==7 || id==4)
	{
		$(".project-code").addClass("hide-cards");
	}
	else if (id==12) 
